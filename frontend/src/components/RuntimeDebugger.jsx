			...
			renderCell: (params) => {
				...
				if (params.row.workflow.triggers !== null) {
					for (let key in params.row.workflow.triggers) {
						if (params.row.workflow.triggers[key].app_name === "User Input" || params.row.workflow.triggers[key].app_name === "Gsoc2 Workflow") { 
							extraItems += 1
						}
					}
				}
				...
				return (
					<div style={{display: "flex", }}>
					  <Tooltip arrow placement="left" title={
						...
						<Tooltip arrow title="Force continue workflow. Only workflows for workflows in EXECUTING state. This is NOT a rerun, but way for Gsoc2 to figure out the next steps automatically. If the execution doesn't finish even after trying this, please contact support@gsoc2r.io"> 
						  <IconButton
							style={{marginLeft: 5, }}
