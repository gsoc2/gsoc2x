  ...
  const AppActionArguments = (props) => {
    ...
    const changeActionParameter = (event, count, data, viewForceUpdate) => {
      ...
      selectedAction.parameters[count].value = event.target.value;
			...
			if (isCloud && (selectedAction.app_name === "Gsoc2 Tools" || selectedAction.app_name === "email") && (selectedAction.name === "send_email_gsoc2" || selectedAction.name === "send_sms_gsoc2") && data.name === "apikey") {
				console.log("APIKEY - this shouldn't show up!")
			}

			if (selectedAction.app_name === "Gsoc2 Tools" && selectedAction.name === "filter_list" && data.name === "input_list") {
        ...
        <div style={{ marginTop: hideExtraTypes ? 10 : 30 }}>
          ...
          {selectedActionParameters.map((data, count) => {
            ...
            const clickedFieldId = "rightside_field_" + count;
						...
						const gsoc2code = fieldCount !== count ? null : 
						(
							<Gsoc2CodeEditor
								isCloud={isCloud}
                    ...
                    >
                      ...
                      />
									...
									{hasAutocomplete === true ? 
										<Tooltip
											color="primary"
											title={"Field was autocompleted by Gsoc2 based on previous actions (same fields or parent nodes)"}
											placement="top"
										>
