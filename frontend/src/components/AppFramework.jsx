...
const AppFramework = (props) => {
  ...
  const alert = useAlert()
	...
	useEffect(() => {
		...
		if (discoveryWrapper === undefined || discoveryWrapper.id === "GSOC2" || discoveryWrapper.id === undefined || cy === undefined) {
			setDiscoveryData({})
  ...
  const onEdgeSelect = (event) => {
	...
	if (cy !== undefined && cy.elements().length === 0 && parsedFrameworkData !== undefined) {
		...
		const foundMiddleImage = userdata !== undefined && userdata !== null && userdata.active_org !== undefined && userdata.active_org.image !== undefined && userdata.active_org.image !== null && userdata.active_org.image !== "" ? userdata.active_org.image : '/images/Gsoc2_logo.png'
