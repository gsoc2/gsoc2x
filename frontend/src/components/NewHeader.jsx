      ...
      >
        ...
        >
          ...
          <Typography variant="body2">
            Notifications generated made by Gsoc2 to help you discover issues or 
        ...
        <div style={{ flex:  isLoggedIn ? null : 1, display: "flex", flexDirection: "row-reverse" }}>
          ...
          >
            ...
            userdata.app_execution_usage < 1000 ? null : (
              <Tooltip
                title={`Amount of executions left: ${userdata.app_execution_usage} / ${userdata.app_execution_limit}. When the limit is reached, you can still use Gsoc2 normally, but your Workflow triggers may stop working. Reach out to support@gsoc2r.io to extend this limit.`}
              >
                <div
                  style={{
                    maxHeight: 30,
