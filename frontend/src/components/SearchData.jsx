...
const SearchData = props => {
    ...
    // useEffect(() => {
    // 	if (searchOpen) {
    // 		var tarfield = document.getElementById("gsoc2_search_field")
    // 		tarfield.focus()
    // 	}
    // }, searchOpen)
            ...
            <Grid item xs={6} style={{ alignItems: "center", flexDirection: "row", marginTop: 70,  }}>
                <List style={{ width: "100%", marginLeft: 10, color: "var(--Paragraph-text, #C8C8C8)" }}>
                    ...
                    <div style={{ marginLeft: 25, }}>
                        ...
                        <ListItem>
                            <Link to="https://github.com/Gsoc2/Gsoc2/blob/main/.github/install-guide.md" style={{ textDecoration: "none", color: "var(--Paragraph-text, #C8C8C8)", display: "flex" }}>
