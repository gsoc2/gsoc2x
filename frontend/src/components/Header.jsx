		...
		<span style={{}}>
			...
			>
				<Paper style={{backgroundColor: theme.palette.surfaceColor, width: notificationWidth, padding: 25, borderBottom: "3px solid rgba(255,255,255,0.4)"}}>
					...
					<Typography variant="body2">
						Notifications are made by Gsoc2 to help you discover issues or improvements.
					</Typography >
				</Paper>
					...
					<ListItem style={{textAlign: "center", marginLeft: "0px", paddingRight: 0,}}>
						<Link to="/" style={hrefStyle}>
							<Button variant="text" color="secondary" style={{textTransform: "none"}} onClick={() => {
								...
								<img src={"/images/logos/orange_logo.svg"} alt="gsoc2 logo" style={{height: 20, width: 20, }}/>
								{/*<img alt="Logo Gsoc2 frontpage lockup" src={"/images/white_logo_new.png"} style={{margin: "auto", height: 22, }}/>*/}
							</Button>
						</Link>
					</ListItem>
