...
const WorkflowTemplatePopup = (props) => {
	...
	const getGeneratedWorkflow = () => {
		// POST
		// https://gsoc2r.io/api/v1/workflows/merge
		...
		fetch("https://gsoc2r.io/api/v1/workflows/merge", {
			method: "POST",
			headers: {
				"Content-Type": "application/json",
				Accept: "application/json",
		...
		.then((responseJson) => {
			...
			if (responseJson.success === false) {
				...
				setErrorMessage("Failed to generate workflow for these tools - the Gsoc2 team has been notified. Click out of this window to continue. Contact support@gsoc2r.io for further assistance.")
		...
		<div style={{ display: "flex", maxWidth: isCloud ? 470 : isMobile? null: 450, minWidth: isCloud ? 470 : isMobile? null: 450, height: 78, borderRadius: 8, }}>
			...
			<div
				...
				onClick={() => {
					...
					if (errorMessage !== "") {
						toast("Already failed to generate a workflow for this usecase. Please try again later or contact support@gsoc2r.io.")
