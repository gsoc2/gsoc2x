...
const Billing = (props) => {
  ...
  const [dealerror, setDealerror] = React.useState("");
    ...
    if (orgId.length === 0) {
      toast(
        "Organization ID not defined (get deals). Please contact us on https://gsoc2r.io if this persists logout."
      );
      return;
    }
							...
							<Button 
								...
								onClick={() => {
									if (isCloud) {
										...
										window.open("https://gsoc2r.io/pricing?tab=onprem&highlight=true", "_blank")
									}
								}}
							>
								Upgrade now	
		...
		<div>
			...
			<Typography variant="body1" color="textSecondary" style={{ marginTop: 0, marginBottom: 10}}>
				{isCloud ? 
					...
					:
					"Gsoc2 is an Open Source automation platform, and no license is required to use it. You may however activate Cloud Sync, get our Scale license, get help with Kubernetes, or talk to Gsoc2's Support team to get automation help."
				}
			</Typography>
			...
			{userdata.support === true ? 
				<div style={{marginBottom: 10, }}>
					...
					&nbsp; - &nbsp;
					<a href={"https://github.com/Gsoc2/Gsoc2-docs/tree/master/handbook/Sales"} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "#f85a3e" }}>
						Sales Process
					</a>
