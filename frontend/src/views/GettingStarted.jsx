...
const GettingStarted = (props) => {
  ...
  document.title = "Getting Started with Gsoc2";
				...
				html: 
					<Typography variant={textType} style={{marginTop: textSpacingDiff, textAlign: "left",}}>
  						...
  						if (isCloud) {
							...
							const ele = document.getElementById("gsoc2_search_field")
