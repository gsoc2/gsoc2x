      ...
      >
        ...
        {loginViewLoading ? (
          <div style={{ textAlign: "center", marginTop: 50 }}>
            ...
            >
              Waiting for the Gsoc2 database to become available. This may
              take up to a minute.
            </Typography>
            ...
            >
              ...
              >
                <b>
                  Are you sure Gsoc2 is{" "}
                  <a
                    rel="norefferer"
                    target="_blank"
                    href="https://github.com/gsoc2/Gsoc2/blob/master/.github/install-guide.md"
              ...
              <Typography
                ...
                style={{ marginBottom: 20, color: "white" }}
              >
                <b>1.</b> Make sure gsoc2-database folder has correct access, and that you have a minimum of <b>2Gb of RAM available</b>:{" "}
                <br />
                <br />
                sudo chown -R 1000:1000 gsoc2-database
              </Typography>
              <Typography
                variant="body2"
                style={{ marginBottom: 20, color: "white" }}
              ...
              >
                ...
                <br />
                <br />
                sudo docker restart gsoc2-opensearch
              </Typography>
            </Paper>
            <Typography
              variant="body2"
