		...
		<div style={{
			...
			marginTop: 50, 
				...
				<div style={{textAlign: "left"}}>
					...
					<Typography variant="body1">
						<b>Security first.</b> We incentivize trying before buying, and give you the full set of tools you need to automate your operations. What's more is we also help you <a href="https://soc2.khulnasoft.com/pricing?tag=docs" target="_blank" style={hrefStyle2}>find usecases</a> that fit your your unique needs. Accessibility is key, and we intend to help every SOC globally use and share their usecases.
					</Typography>

					<Typography variant="h6" style={headerStyle}>Get help</Typography>
					<Typography variant="body1">
						<b>Our promise</b> is to make it easier and easier to automate your operations. In some cases however, it may be good with a helping hand. That's where <a href="https://soc2.khulnasoft.com/pricing?tag=docs" target="_blank" style={hrefStyle2}>Gsoc2's consultancy and support</a> services come in handy. We help you build and automate your operational processes to a level you haven't seen before with the help of our <a href="https://soc2.khulnasoft.com/usecases?tag=docs" target="_blank" style={hrefStyle2}>usecases</a>.
					</Typography>
