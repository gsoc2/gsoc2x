...
const PaymentField = (props) => {
  ...
  let navigate = useNavigate();
	...
	const [gsoc2Variant, setGsoc2Variant] = useState(isCloud ? 0 : 1)
  ...
  const [showPricing, ] = useState(true)
    ...
    useEffect(() => {
		console.log("New variant: ", gsoc2Variant)
	...
	*/
	...
	{
		"name": "Gsoc2 creates integration",
		"basic": "No",
		"community": "Yes",
		"pro": "Yes",
		"enterprise": "",
	...
	{
		"name": "Gsoc2 Custom Modifications",
		"basic": "Contact us",
		"community": "No",
		"pro": "Contact us",
		"enterprise": "",
	...
	const level2Button = 
		<Button fullWidth disabled={false} variant="contained" color="primary" style={{marginTop: gsoc2Variant === 0 ? 20 : 45, borderRadius: 25, height: 40, fontSize: 14, color: "white", backgroundImage: buttonBackground,}}onClick={() => {
	...
	const level3Button = skipFreemode ? null : 
			<Button fullWidth disabled={false} variant="contained" color="primary" style={{borderRadius: 25, height: 40, margin: "15px 0px 15px 0px", fontSize: 14, color: "white", backgroundImage: buttonBackground,}} onClick={() => {
				...
				if (gsoc2Variant === 0) {
					...
					window.location.href = "https://github.com/Gsoc2/Gsoc2/blob/master/.github/install-guide.md"
				}
		...
		<div style={{textAlign: "center"}}>
			...
			<div style={{width: "100%", margin: "auto", backgroundColor: "#1f2023", position: "sticky", top: 0, paddingBottom: 20, zIndex: 10000,}}>
				<ButtonGroup style={{height: 50, marginTop: 30, }} color="primary" aria-label="outlined secondary button group">
					<Button style={{width: 150, textTransform: "none",}} variant={gsoc2Variant === 0 ? "contained" : "outlined"} onClick={(event) => {
					...
					<Button style={{width: 150, textTransform: "none",}} variant={gsoc2Variant === 1 ? "contained" : "outlined"} onClick={(event) => {
						event.preventDefault()
			...
			<div style={{display: "flex", margin: "auto", marginTop: 30, }}>
				<Grid container spacing={4} style={{width: maxwidth/4*2.4 , margin: "auto",}}>
							...
							<CardContent style={{padding: 35}}>
								...
								<span style={{textAlign: "left", }}>
									...
									<Typography variant="body1">
										...
										}}>Free Support</span> & <a rel="noreferrer noopener" target="_blank" style={{textDecoration: "none", color: "#f85a3e",}} href="https://github.com/gsoc2/gsoc2">Discord access</a>
									</Typography>
								</span>
								<div style={{height: 70}} />
								{level3Button}
					...
					<Grid item xs={isMobile ? 12 : 6}>
						<Card style={cardStyle}>	
							<CardContent style={{padding: 35}}>
								<Typography variant="h4">{gsoc2Variant === 1 ? "Scale" : "Enterprise"}</Typography>
								<Typography variant="body1" color="textSecondary">
									{gsoc2Variant === 0 ? 
										"SaaS / Cloud"
										:
								...
								<Typography variant="body1" color="textSecondary" style={{}}>Per month for {gsoc2Variant === 1 ? `${selectedValue} CPU cores` : `${selectedValue}k App Executions`}: </Typography>
								<div> 
									...
									<Slider
										...
										marks
										value={selectedValue}
										step={gsoc2Variant === 0 ? 100 : 4}
										min={gsoc2Variant === 0 ? 100 : 8}
										max={gsoc2Variant === 0 ? 1000 : 32}
								...
								<span style={{textAlign: "left", }}>
									...
									<Divider />
									<Typography variant="body1">
										{defaultTaskIcon} {gsoc2Variant === 0 ? 
											"Multi-Tenant"
											:
											"Scalable Orborus"
										}
			...
			<div style={{maxWidth: maxwidth, margin: "auto",}}>
				...
				{/*
				<Typography color="textSecondary" style={{marginTop: 25, textAlign: isMobile ? "left" : "center",}}>
					Gsoc2 is an <a rel="noreferrer noopener" target="_blank" style={{textDecoration: "none", color: "#f85a3e",}} href="https://github.com/gsoc2/gsoc2">Open Source</a> project. Gives access to support, development and features not otherwise available. This applies to both Open Source & Cloud/SaaS. After the transaction is finished, you will immediately have full access to our support team, and you organization will automatically get upgraded resources assigned. 
				</Typography>
				*/}
			...
			{!showPricing ? 
				...
				<div style={{maxWidth: isMobile ? maxwidth : maxwidth+500, margin: "auto", marginTop: 25, }}>
					<Typography variant="h4" style={{marginBottom: 10, textAlign: "center",}}>Features ({gsoc2Variant === 0 ? "Cloud" : "Self-Hosted"})</Typography>
					<List style={{marginTop: 15, }}>
						...
						{features.slice(0, parsedFields).map((data, index) => {
							...
							if (gsoc2Variant === 0 && data.cloud === false) {
								indexskip += 1
								return null
							}

							if (gsoc2Variant === 1 && data.onprem === false) {
								indexskip += 1
								return null
							}
			...
			<Typography variant="body1" color="textSecondary" style={{margin: "auto", width: maxwidth/3*2, marginBottom: 25, }}>
				Our support model is built for both the Cloud and Onpremises version of Gsoc2, and can be managed between both. <Link rel="noreferrer noopener" target="_blank" style={{textDecoration: "none", color: "#f85a3e",}} to="/contact">Contact us </Link>for more info, or to get a quote from one of our <Link rel="noreferrer noopener" target="_blank" style={{textDecoration: "none", color: "#f85a3e",}} to="/partner">verified resellers.</Link>
			</Typography>
      <img src="images/partner/models.jpeg" alt="Gsoc2 MSSP and Open Source" style={{width: isMobile ? "100%" : 500, margin: "auto", borderRadius: theme.palette.borderRadius, }} />
	...
	const modalView = modalOpen ? 
		...
		>
			<FormControl>
				<DialogTitle><div style={{color: "white"}}>Gsoc2 payments</div></DialogTitle>
				<DialogContent>
					<Typography variant="body1">
						Choose recurrence
					</Typography>
					...
					<Card style={{marginTop: 25, backgroundColor: theme.palette.surfaceColor}}>
						<CardContent style={{padding: 25}}>
							...
							<Typography color="textSecondary">
								Gsoc2 <b>{variant === 0 ? "Community" : variant === 2 ? "Free" : "Pro"}</b> Edition
							</Typography>
