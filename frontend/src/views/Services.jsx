				...
				<Paper style={{maxWidth: paperWidth, minWidth: paperWidth, marginBottom: margin/2, marginTop: margin, backgroundColor: theme.palette.surfaceColor, color: "white", padding: isMobile ? 0 : margin, display: "flex", flexDirection: isMobile ? "column": "row", }}>
					...
					<div style={{flex: 6, marginLeft: isMobile ? margin : 40, marginRight: isMobile ? margin: 0, marginTop: isMobile ? 30 : 0}}>
						...
						<Typography variant="body1" style={{marginTop: 20,}}>
							Gsoc2 was built by and for security professionals. We aim to bring our unique toolbox to every operations center globally, enabling information sharing and collaboration at scale, whether in the cloud, or on-premises.  
						</Typography>	
					</div>
				</Paper>
				<Paper style={{maxWidth: paperWidth, minWidth: paperWidth, marginBottom: margin/2, marginTop: margin, backgroundColor: theme.palette.surfaceColor, color: "white", padding: isMobile ? 0 : margin, display: "flex", flexDirection: isMobile ? "column": "row",}}>
				...
				<Paper style={{maxWidth: paperWidth, minWidth: paperWidth, marginBottom: margin/2, marginTop: margin, backgroundColor: theme.palette.surfaceColor, color: "white", padding: isMobile ? 0 : margin, display: "flex",flexDirection: isMobile ? "column": "row",}}>
					...
					<div style={{flex: 6, marginLeft: isMobile ? 0 :40,}}>
						...
						<Typography variant="body1" color="textSecondary" style={{marginTop: 20,}}>
							We recognize that support is a vital part of keeping operations stable and secure. That's why we're offering support of both the cloud platform and usage, as well as for the open source version of Gsoc2.
						</Typography>	
					</div>
				</Paper>
				<Paper style={{maxWidth: paperWidth, minWidth: paperWidth, marginBottom: margin/2, marginTop: margin, backgroundColor: theme.palette.surfaceColor, color: "white", padding: isMobile ? 0 : margin, display: "flex",flexDirection: isMobile ? "column": "row",}}>
					<div style={{flex: 6, marginRight: 40,}}>
						...
						<Typography variant="body1" style={{marginTop: 20,}}>
							We teach you how to become a poweruser of Gsoc2. It involves how to maintain, create, share and use it Gsoc2, whether in a small operations center or as an MSSP. 
						</Typography>	
					</div>
					<div style={{flex: 3, borderLeft: "1px solid rgba(255,255,255,0.2)"}}>
						<List style={{marginLeft: isMobile ? 0 : 40,}}>
