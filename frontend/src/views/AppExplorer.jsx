                    ...
                    <Item>
                      ...
                      <div class="row">
                        ...
                        <div class="column" style={{ float: "left" }}>
                          <img src={algoliaResult[0]["image_url"]} alt="gsoc2" width="50px" />
                        </div>
                ...
                <Grid item xs={2} sm={4} md={4} key={index}>
                  <a href="#" style={link}>
                    <Item>
                      <div class="row">
                        <div class="column" style={{ float: "left" }}>
                          <img src="/images/testing.png" alt="gsoc2" width="50px" />
                        </div>
                        <div class="column " style={boxdata}>
                          <div style={boxdata}>
                            <Typography align="left" variant="body1">
                ...
                <Grid item xs={2} sm={4} md={4} key={index}>
                  ...
                  <div className="row" >
                    <div className="column" style={{ float: "left", width: "33.33%", marginTop: "20px", marginBottom: "20px", }}>
                      <img src="/images/gsoc2_logo.png" alt="gsoc2" width="200px" />
                    </div>
                  </div>
            ...
            <div className="col" style={{ float: "right" }}>
              <div className="row" style={{ float: "left", marginLeft: "90px" }}>
                <div className="column" style={{ float: "left", margin: "60px 10px 20px 30px" }}>
                  <img src="/images/demo1.png" alt="gsoc2" width="90px" />
                </div>
                <div className="column" style={{ float: "left", margin: "60px 10px 20px 30px" }}>
                  <img src="/images/demo1.png" alt="gsoc2" width="90px" />
                </div>
