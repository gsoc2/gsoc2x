...
const Apps = (props) => {
  ...
  const baseRepository = "https://github.com/gsoc2/gsoc2-apps";
      ...
      <div style={{}}>
        <Paper square style={uploadViewPaperStyle}>
          <div style={{ margin: 25 }}>
            ...
            <a
              rel="noopener noreferrer"
              href="https://github.com/gsoc2/security-openapis"
              style={{ textDecoration: "none", color: "#f85a3e" }}
              target="_blank"
            >
              Security API's
    ...
    >
      ...
      <DialogContent style={{ color: "rgba(255,255,255,0.65)" }}>
        ...
        <TextField
          ...
          variant="outlined"
          margin="normal"
          defaultValue={"https://github.com/gsoc2/gsoc2-apps"}
          InputProps={{
            style: {
              color: "white",
              height: "50px",
      ...
      <FormControl>
        ...
        <DialogContent style={{ color: "rgba(255,255,255,0.65)" }}>
		  <Typography variant="body1">
		  	Paste in a URL, and we will make it into an app for you. This may take multiple minutes based on the size of the documentation. <b>{isCloud ? "" : "Uses Gsoc2 Cloud (https://gsoc2r.io) for processing (for now)."}</b> 
		  </Typography>
		  <TextField
            style={{ backgroundColor: inputColor }}
            variant="outlined"
