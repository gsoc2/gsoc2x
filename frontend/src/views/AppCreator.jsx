...
const AppCreator = (defaultprops) => {
      ...
      if (item.queries.length > 0) {
        ...
        for (let querykey in item.queries) {
          ...
          var newitem = {
            in: "query",
            name: queryitem.name,
            description: "Generated by gsoc2r.io OpenAPI",
        ...
        for (let querykey in paths) {
      	...
      	if (
      	  ...
      	  data.paths[item.url][item.method.toLowerCase()]["requestBody"] = {
      	    description: "Generated by Gsoc2r.io",
      	    required: required,
      	    content: {
      	      example: {
      	        example: item.body,
        ...
        for (let headerkey in headersSplit) {
          ...
          if (innerkey.length > 0 && value.length > 0) {
            newitem = {
              ...
              name: innerkey,
              multiline: false,
              description: "Header generated by gsoc2r.io OpenAPI",
              required: false,
              example: value,
              schema: {
                type: "string",
    		...
    		>
    		  <FormControl style={{ backgroundColor: surfaceColor, color: "white" }}>
    		    ...
    		    <DialogContent>
    		      <a
    		        target="_blank"
    		        href="https://gsoc2r.io/docs/app_creation#actions"
        ...
        <div>
          <DialogContent>
            <a
              target="_blank"
              rel="norefferer"
              href="https://gsoc2r.io/docs/app_creation#authentication"
              style={{ textDecoration: "none", color: "#f85a3e" }}
            >
              What is this?
            </a>
  ...
  const testView = (
    <div style={{ color: "white" }}>
      ...
      <a
        target="_blank"
        href="https://gsoc2r.io/docs/app_creation#testing"
        style={{ textDecoration: "none", color: "#f85a3e" }}
      >
