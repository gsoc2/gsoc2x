	...
	return (
		<div style={{marginTop: 25, minHeight: 1000,}}>
			...
			<Typography variant="body1">
				Usecases in Gsoc2 are divided into {keys.length} type{keys.length === 1 ? "" : "s"}. 
			</Typography>
												...
												<div style={{flex: 1, textAlign: "left", marginRight: 10, }}>
													...
													: 
														<span style={{display: "flex"}}>
															...
															<a href={`https://gsoc2r.io/search?tab=workflows&q=${subcase.name}`} style={{textDecoration: "none", }} target="_blank" rel="noopener noreferrer">
