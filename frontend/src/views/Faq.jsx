 ...
 * What level of support does Fredrik/Gsoc2 provide to paying customers with enterprise license agreements?
 ...
 * What’s the annual Gsoc2 release schedule / frequency? One major release once a year with minor releases quarterly?
 * The ability to run our own, private instance of Gsoc2 in a public or private cloud, as well as on virtualized or bare metal, standalone/isolated servers is very important.
 * We were wondering how the gsoc2 environment handles a playbook in production(workflow editing and testing phase) vs. in operations (playbook/workflow is operational in a SOC).
 * Is Gsoc2 capable of pushing notifications/messages to REDPro if a playbook is Active, Inactive or in Error so it’s general status can be understood via the Playbook Library.
