...
func main() {
	data := []byte(`{"swagger":"3.0","info":{"title":"hi","description":"you","version":"1.0"},"servers":[{"url":"https://soc2.khulnasoft.com/api/v1"}],"host":"soc2.khulnasoft.com","basePath":"/api/v1","schemes":["https:"],"paths":{"/workflows":{"get":{"responses":{"default":{"description":"default","schema":{}}},"summary":"Get workflows","description":"Get workflows","parameters":[]}},"/workflows/{id}":{"get":{"responses":{"default":{"description":"default","schema":{}}},"summary":"Get workflow","description":"Get workflow","parameters":[{"in":"query","name":"forgetme","description":"Generated by soc2.khulnasoft.com OpenAPI","required":true,"schema":{"type":"string"}},{"in":"query","name":"anotherone","description":"Generated by soc2.khulnasoft.com OpenAPI","required":false,"schema":{"type":"string"}},{"in":"query","name":"hi","description":"Generated by soc2.khulnasoft.com OpenAPI","required":true,"schema":{"type":"string"}},{"in":"path","name":"id","description":"Generated by soc2.khulnasoft.com OpenAPI","required":true,"schema":{"type":"string"}}]}}},"securityDefinitions":{}}`)
