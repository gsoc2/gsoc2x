...
func init() {
	...
	_, err = gsoc2.RunInit(*dbclient, storage.Client{}, gceProject, "onprem", true, "elasticsearch")
	log.Printf("INIT")
}
...
func TestAuthenticationRequired(t *testing.T) {
	handlers := []endpoint{
		{handler: gsoc2.HandleNewOutlookRegister, path: "/functions/outlook/register", method: "GET"},
		{handler: gsoc2.HandleGetOutlookFolders, path: "/functions/outlook/getFolders", method: "GET"},
		{handler: gsoc2.HandleApiGeneration, path: "/api/v1/users/generateapikey", method: "GET"},
		{handler: gsoc2.HandleLogin, path: "/api/v1/users/login", method: "POST"}, // prob not this one
		...
		{handler: gsoc2.HandleGetUsers, path: "/api/v1/users/getusers", method: "GET"},
		{handler: handleInfo, path: "/api/v1/users/getinfo", method: "GET"},
		{handler: gsoc2.HandleSettings, path: "/api/v1/users/getsettings", method: "GET"},
		{handler: gsoc2.HandleUpdateUser, path: "/api/v1/users/updateuser", method: "PUT"},
		{handler: gsoc2.DeleteUser, path: "/api/v1/users/123", method: "DELETE"},
		{handler: gsoc2.HandlePasswordChange, path: "/api/v1/users/passwordchange", method: "POST"},
		{handler: gsoc2.HandleGetUsers, path: "/api/v1/users", method: "GET"},
		{handler: gsoc2.HandleGetEnvironments, path: "/api/v1/getenvironments", method: "GET"},
		{handler: gsoc2.HandleSetEnvironments, path: "/api/v1/setenvironments", method: "PUT"},
		...
		{handler: gsoc2.UpdateWorkflowAppConfig, path: "/api/v1/apps/123", method: "PATCH"},
		{handler: validateAppInput, path: "/api/v1/apps/validate", method: "POST"},
		{handler: gsoc2.DeleteWorkflowApp, path: "/api/v1/apps/123", method: "DELETE"},
		{handler: gsoc2.GetWorkflowAppConfig, path: "/api/v1/apps/123/config", method: "GET"},
		{handler: getWorkflowApps, path: "/api/v1/apps", method: "GET"},
		{handler: setNewWorkflowApp, path: "/api/v1/apps", method: "PUT"},
		//{handler: gsoc2.GetSpecificApps, path: "/api/v1/apps/search", method: "POST"},

		{handler: gsoc2.GetAppAuthentication, path: "/api/v1/apps/authentication", method: "GET"},
		{handler: gsoc2.AddAppAuthentication, path: "/api/v1/apps/authentication", method: "PUT"},
		{handler: gsoc2.DeleteAppAuthentication, path: "/api/v1/apps/authentication/123", method: "DELETE"},
		...
		{handler: gsoc2.GetWorkflows, path: "/api/v1/workflows", method: "GET"},
		{handler: gsoc2.SetNewWorkflow, path: "/api/v1/workflows", method: "POST"},
		...
		{handler: gsoc2.HandleGetSchedules, path: "/api/v1/workflows/schedules", method: "GET"},
		...
		{handler: gsoc2.HandleCreateOutlookSub, path: "/api/v1/workflows/123/outlook", method: "POST"},
		// handleDeleteOutlookSub generates nil pointer exception
		{handler: gsoc2.HandleDeleteOutlookSub, path: "/api/v1/workflows/123/outlook/abc", method: "DELETE"},
		{handler: gsoc2.GetWorkflowExecutions, path: "/api/v1/workflows/123/executions", method: "GET"},
		{handler: gsoc2.AbortExecution, path: "/api/v1/workflows/123/executions/abc/abort", method: "GET"},
		{handler: gsoc2.GetSpecificWorkflow, path: "/api/v1/workflows/123", method: "GET"},
		{handler: gsoc2.SaveWorkflow, path: "/api/v1/workflows/123", method: "PUT"},
		{handler: deleteWorkflow, path: "/api/v1/workflows/123", method: "DELETE"},

		{handler: gsoc2.HandleNewHook, path: "/api/v1/hooks/new", method: "POST"},
		{handler: handleWebhookCallback, path: "/api/v1/hooks/123", method: "POST"},
		{handler: gsoc2.HandleDeleteHook, path: "/api/v1/hooks/123/delete", method: "DELETE"},

		{handler: gsoc2.HandleGetSpecificTrigger, path: "/api/v1/triggers/123", method: "GET"},
		//{handler: gsoc2.HandleGetSpecificStats, path: "/api/v1/stats/123", method: "GET"},

		{handler: verifySwagger, path: "/api/v1/verify_swagger", method: "POST"},
		{handler: verifySwagger, path: "/api/v1/verify_openapi", method: "POST"},
		{handler: gsoc2.EchoOpenapiData, path: "/api/v1/get_openapi_uri", method: "POST"},
		{handler: gsoc2.EchoOpenapiData, path: "/api/v1/validate_openapi", method: "POST"},
		{handler: gsoc2.ValidateSwagger, path: "/api/v1/validate_openapi", method: "POST"},
		{handler: getOpenapi, path: "/api/v1/get_openapi", method: "GET"},

		//{handler: gsoc2.CleanupExecutions, path: "/api/v1/execution_cleanup", method: "GET"},

		{handler: handleCloudSetup, path: "/api/v1/cloud/setup", method: "POST"},
		{handler: gsoc2.HandleGetOrgs, path: "/api/v1/orgs", method: "POST"},
		{handler: gsoc2.HandleGetFileContent, path: "/api/v1/files/{fileId}/content", method: "POST", body: []byte("hi")},
	}
...
func TestAuthenticationNotRequired(t *testing.T) {
	...
	handlers := []endpoint{
		...
		{handler: gsoc2.HandleLogout, path: "/api/v1/users/logout", method: "POST"},
		{handler: gsoc2.GetDocList, path: "/api/v1/docs", method: "GET"},
		{handler: gsoc2.GetDocs, path: "/api/v1/docs/123", method: "GET"},
...
func TestCors(t *testing.T) {
	handlers := []endpoint{
		...
		{handler: handleCloudSetup, path: "/api/v1/cloud/setup", method: "POST"},
		{handler: gsoc2.HandleGetOrgs, path: "/api/v1/orgs", method: "POST"},
		{handler: gsoc2.HandleGetFileContent, path: "/api/v1/files/{fileId}/content", method: "POST"},
	}
